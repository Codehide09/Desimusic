    ...
    <>
      <div className="py-20 mb-30 max-w-3xl mx-auto">
        ...
        <p className="animateHeader text-white text-opacity-50 text-center mt-5">
          How about moderating your own server with DesiMusic? Create your own free world and create your own playlist, experience this pleasure with the best sounds.
        </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">

          <Link href={"https://discord.com/api/oauth2/authorize?client_id=1329485496497344665&permissions=277028620608&scope=applications.commands%20bot"}>
            <a
              className={
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
        <div className="col-span-4">
          <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html: "DesiMusic" }} />
        ...
        <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            <div className="text-white">
              ...
              <p className="text-gray-500 line-clamp-4">With fast and customizable settings specific to your server, DesiMusic gives you a musical pleasure to the fullest.</p>
            </div>
          </div>
          <div>
            <div className="text-white">
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
        <>
          <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
            <img src="https://media.discordapp.net/attachments/1330173357080973394/1333037719038853211/bck4.png?ex=67976f9e&is=67961e1e&hm=4407f3466cae15bcffa64891cf3ba5f217d6e45116a7bdf61db639aa8abac2d4&=&format=webp&quality=lossless&width=560&height=280" width="256" className="lg:hidden rounded-xl mb-5 shadow-xl shadow-black" />
            <p className="text-3xl text-white font-semibold">Best Your Bot</p>
            <p className="text-md text-white font-medium text-gray-500 line-clamp-5">Are you ready to throw the best parties with DesiMusic, the best and most up-to-date bot?</p>
          </div>
          <img src="https://media.discordapp.net/attachments/1330173357080973394/1333037719038853211/bck4.png?ex=67976f9e&is=67961e1e&hm=4407f3466cae15bcffa64891cf3ba5f217d6e45116a7bdf61db639aa8abac2d4&=&format=webp&quality=lossless&width=560&height=280" className="hidden lg:block rounded-xl perspective-right shadow-xl shadow-black" />
        </>
