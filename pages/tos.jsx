  ...
  return (
    <div>
      ...
      <div className="animateHeader text-white text-opacity-40 mt-5">
        ...
        <div className="py-3"></div>
        <p>⊳ To use certain discord bot commands, you need to vote for the <a className="text-white" href="https://top.gg/bot/774043716797071371/vote">DesiMusic</a> bot at certain intervals.</p>
      </div>
    </div>
  );
}
